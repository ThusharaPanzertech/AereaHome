...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        btnDone.frame = CGRect(x: 0, y: 0, width: 100, height: 50)
        btnDone.titleLabel?.font = UIFont(name: "Helvetica-Bold", size: 15)
        btnDone.setTitle("Done", for: .normal)
        btnDone.setTitleColor(textColor, for: .normal)
       // btnDone.backgroundColor = UIColor.red
        btnDone.center = view.center
